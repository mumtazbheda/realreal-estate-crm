...
-- ========== Helper Functions (BEFORE enabling RLS) ==========
...
-- Contacts: allow within tenant membership
...
-- Leads: allow select within tenant membership
...
-- Activity log: allow select within tenant membership
...
-- Webhook events: allow select within tenant membership
...
-- WhatsApp events: allow select within tenant membership
...
-- Email events: allow select within tenant membership
